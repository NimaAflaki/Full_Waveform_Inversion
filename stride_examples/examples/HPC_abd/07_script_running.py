...
async def main(runtime):
    ...
    runtime.logger.info("Porblem created")
    ...
    runtime.logger.info("Starting forward solve…")
    await forward(problem, pde, vp_true, dump="forward_traces.h5")
    runtime.logger.info("Forward solve complete")
